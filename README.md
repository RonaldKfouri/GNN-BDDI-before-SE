...
5. TMeasurement selection - PMUs are placed on odd-indexed nodes, SCADA measurements are placed on even-indexed nodes. Measurement redundancy is guaranteed. You can use any library to prepare the measurements; they should be saved as nodes features, edge features, and encoded outputs;
